...
make_C4_CN_allele <- function( output.test ){
    ...
    C4_CN_allele <- data.frame( SAMPLE= NA, C4_1 = NA, C4_2 = NA, C4A_1= NA, C4A_2= NA, C4B_1 = NA,C4B_2= NA, HERV_1 =NA, HERV_2 =NA)
    ...
    for(i in 1:sam) {
        ...
        colnames(t) <- c("SAMPLE", "C4_1", "C4_2", "C4A_1","C4A_2", "C4B_1","C4B_2", "HERV_1", "HERV_2")
...
make_C4_CN_masked <- function( test_bgl ){
        ...
        C4_CN_masked <- data.frame( SAMPLE= NA, C4_1 = NA, C4_2 = NA, C4A_1= NA, C4A_2= NA, C4B_1 = NA,C4B_2= NA, HERV_1 =NA, HERV_2 =NA)
...
to <- c( concor_cal(table( C4_allele_val$C4 ) , 1 ,  nrow(C4_allele_val)) ,
