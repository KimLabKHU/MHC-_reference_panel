...
table(  ( total_C4_CN$C4A + total_C4_CN$C4B ) == total_C4_CN$C4  )
total_C4_CN[ ( total_C4_CN$C4A + total_C4_CN$C4B ) != total_C4_CN$C4 , ] 
total_C4_CN[ !( ( total_C4_CN$C4A + total_C4_CN$C4B ) == total_C4_CN$C4 ) ,  ]

# "imputed" diploid dist.
(table( total_C4_CN$C4 )/nrow(total_C4_CN))*100

total_C4_CN[ total_C4_CN$C4 < total_C4_CN$HERV , ]  # 이상한 샘플 QC quality 확인

not_matched_sum <- total_C4_CN[ which( total_C4_CN$C4!=(total_C4_CN$C4A+total_C4_CN$C4B)  ), ]$SAMPLE
not_matched_herv <- total_C4_CN[ which( total_C4_CN$C4 < total_C4_CN$HERV  ), ]$SAMPLE

length(not2copy_samples);length(not_matched_sum);length(not_matched_herv)
...
filter(total_table, AB_QUAL <5)$SAMPLE
...
colnames(total_C4_CN)[2:5] <- paste0("imputed_" ,colnames(total_C4_CN)[2:5] )
...
# opt=list(); opt$snpver="ver3"; opt$region="start31.7end32.2"; opt$haplonetver="ver1_best"; opt$crossval="crossval1"
# opt=list(); opt$snpver="ver3"; opt$region="start31.7end32.2QUAL30"; opt$haplonetver="ver2_best"; opt$crossval="crossval1"
# opt=list(); opt$snpver="ver4"; opt$region="start31.7end32.2_highLDfiltering_50_5_0.8"; opt$haplonetver="ver1_best"; opt$crossval="crossval1"
###############################################################################################
