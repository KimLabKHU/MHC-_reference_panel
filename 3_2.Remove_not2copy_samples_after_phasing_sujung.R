...
# opt=list(); opt$snpver="ver4"; opt$region="start31.7end32.2_highLDfiltering_50_5_0.8QUAL20"; opt$haplonetver="ver1_sujung"
...
table( (C4_CN$C4A + C4_CN$C4B) >= C4_CN$HERV )


head(C4_CN_for2copy_check)
...
total_C4_CN_for2copy_check [ which(total_C4_CN_for2copy_check[2:4] !="1_1" ,arr.ind=TRUE)[,1] , ]
...
not_matched_herv <- C4_CN[ which( (C4_CN$C4A+C4_CN$C4B) < C4_CN$HERV  ), ]$SAMPLE

length(not_matched_herv)
